...
const VehiclePanel = (props) =>{
    return(
        <div>
            <h5 className="w-[93%] text-center absolute top-0" onClick={()=>{props.setVehiclePanel(false)}}><i className="text-4xl text-gray-200 ri-arrow-down-wide-line"></i></h5>
            <h3 className='text-2xl font-semibold mb-3 pt-4'>Choose a Vehicle</h3>
            <div onClick={()=>{props.setConfirmRidePanel(true)}} className='flex border-2 active:border-black mb-2 rounded-xl w-full items-center justify-between p-3'>
            ...
            <div onClick={()=>{props.setConfirmRidePanel(true)}} className='flex border-2 active:border-black mb-2 rounded-xl w-full items-center justify-between p-3'>
                ...
                <h2 className='text-lg font-semibold '>₹110.86</h2>
            </div>
            <div onClick={()=>{props.setConfirmRidePanel(true)}} className='flex border-2 active:border-black mb-2 rounded-xl w-full items-center justify-between p-3'>
